/**
 * CC direct chat — owner closes a session.
 *
 * ──────────────────────────────────────────────────────────────────────────────
 * POST http://localhost:3000/api/chat/cc-direct/rooms/{chatId}/close
 * ──────────────────────────────────────────────────────────────────────────────
 * Auth:    Bearer <owner_or_admin_id_token>
 * Body:    none
 *
 * Success — 200:  { "ok": true }
 * Effect:         sessionStatus → closed; same chatId can reopen when agent sends again
 */
...
/**
 * POST /api/chat/cc-direct/rooms/:chatId/close
 * Ends the CC direct session from the workshop side.
 */
