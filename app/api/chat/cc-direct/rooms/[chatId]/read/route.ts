/**
 * CC direct chat — owner marks agent messages as read.
 *
 * ──────────────────────────────────────────────────────────────────────────────
 * POST http://localhost:3000/api/chat/cc-direct/rooms/{chatId}/read
 * ──────────────────────────────────────────────────────────────────────────────
 * Auth:    Bearer <owner_or_admin_id_token>
 * Body:    none
 *
 * Success — 200:  { "ok": true }
 * Firestore:      messages.seenByRecipient + unreadForTenant cleared
 */
...
/**
 * POST /api/chat/cc-direct/rooms/:chatId/read
 * Clears unread state when the owner views the CC thread.
 */
