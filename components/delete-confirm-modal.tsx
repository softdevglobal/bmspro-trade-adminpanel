      ...
      >
        ...
        <div className="mt-6 flex flex-col-reverse gap-2 border-t border-outline-variant bg-surface-container-low px-6 py-4 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isLoading}
            className="flex h-11 items-center justify-center gap-2 rounded-lg bg-error px-5 font-body text-[14px] font-semibold text-on-error transition-all hover:bg-error/90 disabled:cursor-not-allowed disabled:opacity-70"
          >
            {isLoading ? (
              <>
